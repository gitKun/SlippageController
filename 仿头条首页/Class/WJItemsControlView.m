...
//    }
    if ([self.mDelegate respondsToSelector:@selector(WJItemsControlView:clickAtIndex:animation:)]) {
        [_mDelegate WJItemsControlView:self clickAtIndex:_currentIndex animation:_tapAnimation];
    }
}
